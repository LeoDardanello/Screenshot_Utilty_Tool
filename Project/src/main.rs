...
impl eframe::App for MyApp {
    ...
    fn update(&mut self, ctx: &egui::Context, frame: &mut eframe::Frame) {
        ...
        custom_window_frame(
            ...
            |frame: &mut eframe::Frame, mode, ui| {
                ...
                if *mode == 0 {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.vertical(|ui| {
                            if ui
                                .add(egui::RadioButton::new(self.output_format == ".jpg", ".jpg"))
                                .clicked()
                            {
                            ...
                            if ui
                                .add(egui::RadioButton::new(self.output_format == ".png", ".png"))
                                .clicked()
                            {
                                self.output_format = String::from(".png");
                            }
                            if ui
                                .add(egui::RadioButton::new(self.output_format == ".gif", ".gif"))
                                .clicked()
                            {
                    ...
                    if frame.info().window_info.fullscreen == true {
...
fn custom_window_frame(
    ...
    title: &str,
    add_contents: impl FnOnce(&mut eframe::Frame, &mut i32, &mut egui::Ui),
) {
    ...
    egui::CentralPanel::default()
        ...
        .show(ctx, |ui| {
            ...
            add_contents(frame, mode, &mut content_ui);
        });
}
